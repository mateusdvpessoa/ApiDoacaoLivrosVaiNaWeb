...
def listar_livros():
    with sqlite3.connect('database.db') as  conn:
        #fetchall() é utilizado após realizar a conexão com o banco de dados para buscar todos os resultados e armazenar na variável passada
        ...
        # O append serve para guardar o conteúdo na estrutura de armazenamento de dados
